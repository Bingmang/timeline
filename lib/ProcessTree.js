...
class ProcessTree {
  ...
  async sendSignal(signal) {
    ...
    await _killAll(this.process_tree, signal)
  }
  ...
  async init() {
    ...
    this.process_list = $._.keys(this.process_tree)
  }
}
...
function _checkPidsAlive(pid_list) {
  return new $.Promise((resolve, reject) => {
    ...
    $.child_process
      .exec(`ps -o pid | grep -E '${query}'`, (err, stdout, stderr) => {
        err ? resolve([]) :
