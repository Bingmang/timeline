...
const NPM_DIR = $.conf.timeline.npm_dir
const SCAN_DIR_SCHEDULE = $.conf.timeline.scan_dir_schedule
const CONFIG_NAME = $.conf.timeline.config_name
...
timeline.on('fail', (error, job) => {
  ...
  $.log.error(error)
  $.alarmWechat(package_configs[job_name].maintainer,
